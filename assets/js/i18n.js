...
const DICTS = {
  en: {
    ...
    "work.no_repos":            "No public repos.",
    "work.load_failed":         "Could not load projects.",
    "work.view_github":         "View on GitHub →",
    "work.preview.no_desc":     "No description provided.",
    "work.preview.license":     "License",
    "work.preview.branch":      "Branch",
    "work.preview.dash":        "—",
    "work.preview.private_msg": "Private repository — no README available. Use the live demo.",
    "work.preview.readme_click":   "Click the card to load README.",
    "work.preview.readme_loading": "Loading README…",
    "work.preview.readme_none":    "No README found.",
    ...
    "journal.post.edit":       "Edit",
    "journal.post.delete":     "Delete",
  ...
  tr: {
    ...
    "work.no_repos":            "Genel depo yok.",
    "work.load_failed":         "Projeler yüklenemedi.",
    "work.view_github":         "GitHub'da gör →",
    "work.preview.no_desc":     "Açıklama yok.",
    "work.preview.license":     "Lisans",
    "work.preview.branch":      "Dal",
    "work.preview.dash":        "—",
    "work.preview.private_msg": "Özel depo — README yok. Canlı demoyu kullan.",
    "work.preview.readme_click":   "README yüklemek için karta tıkla.",
    "work.preview.readme_loading": "README yükleniyor…",
    "work.preview.readme_none":    "README bulunamadı.",
    ...
    "time.minute":             "dakika",
    "time.minutes":            "dakika",
    "journal.min_read":        "dk okuma",
    "journal.section":         "bölüm",
    "journal.sections":        "bölüm",
    "journal.post.edit":       "Düzenle",
    "journal.post.delete":     "Sil",
  ...
  ar: {
    ...
    "work.no_repos":            "لا توجد مستودعات عامة.",
    "work.load_failed":         "تعذّر تحميل المشاريع.",
    "work.view_github":         "اعرض على GitHub ←",
    "work.preview.no_desc":     "لا يوجد وصف.",
    "work.preview.license":     "الترخيص",
    "work.preview.branch":      "الفرع",
    "work.preview.dash":        "—",
    "work.preview.private_msg": "مستودع خاص — لا يوجد README. استخدم العرض الحي.",
    "work.preview.readme_click":   "اضغط البطاقة لتحميل README.",
    "work.preview.readme_loading": "جارٍ تحميل README…",
    "work.preview.readme_none":    "لم يُعثر على README.",
    "time.updated":            "حُدِّث",
    "time.ago":                "منذ",
    "time.just_now":           "للتو",
    "time.year":               "سنة",
    ...
    "time.minute":             "دقيقة",
    "time.minutes":            "دقائق",
    "journal.min_read":        "د قراءة",
    "journal.section":         "قسم",
    "journal.sections":        "أقسام",
    "journal.post.edit":       "تحرير",
    "journal.post.delete":     "حذف",
